...
class ReferenceController extends AbstractController
{
    ...
    public function create(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $this->referenceService->removeEmptyMedia($reference);
            $this->getDoctrine()->getManager()->persist($reference);
            $this->getDoctrine()->getManager()->flush();
            $this->addFlash('success', 'Référence ajoutée avec succès !');
    ...
    public function update(Reference $reference, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $this->referenceService->removeEmptyMedia($reference);
            $this->getDoctrine()->getManager()->flush();
            $this->addFlash('success', 'Référence modifiée avec succès !');
    ...
    public function delete(Reference $reference): RedirectResponse
    {
        ...
        $this->getDoctrine()->getManager()->flush();
        $this->addFlash('success', 'Référence supprimée avec succès !');
